...
class VisualizerApp:
    def __init__(self):
        ...
        self.color_mode = ColorMode(
            self.component_initializer.ledsettings.color_mode,
        ...
        self.web_interface_manager = WebInterfaceManager(
            self.args,
            self.component_initializer.usersettings,
            self.component_initializer.ledsettings,
            self.component_initializer.ledstrip,
        ...
        self.midi_event_processor = MIDIEventProcessor(
            self.component_initializer.midiports,
            self.component_initializer.ledstrip,
            self.component_initializer.ledsettings,
            self.component_initializer.usersettings,
        ...
        self.led_effects_processor = LEDEffectsProcessor(
            self.component_initializer.ledstrip,
            self.component_initializer.ledsettings,
            self.component_initializer.menu,
            self.color_mode,
    ...
    def check_screensaver(self):
        if int(self.component_initializer.menu.screensaver_delay) > 0:
            if (time.time() - self.component_initializer.midiports.last_activity) > (
                int(self.component_initializer.menu.screensaver_delay) * 60
            ):
                screensaver(
                    self.component_initializer.menu,
                    self.component_initializer.midiports,
    ...
    def check_activity_backlight(self):
        if (time.time() - self.component_initializer.midiports.last_activity) > 120:
            if not self.backlight_cleared:
                ...
                fastColorWipe(
                    self.component_initializer.ledstrip.strip,
                    True,
                    self.component_initializer.ledsettings,
                )
    ...
    def check_color_mode(self):
        if (
            self.component_initializer.ledsettings.color_mode != self.color_mode_name
            or self.component_initializer.ledsettings.incoming_setting_change
        ):
    ...
    def check_settings_changes(self):
        if (time.time() - self.component_initializer.usersettings.last_save) > 1:
            ...
            if self.component_initializer.usersettings.pending_reset:
                ...
                self.component_initializer.ledsettings = LedSettings(
                    self.component_initializer.usersettings
                )
                self.component_initializer.ledstrip = LedStrip(
                    self.component_initializer.usersettings,
                    self.component_initializer.ledsettings,
                )
                self.component_initializer.menu = MenuLCD(
                    "config/menu.xml",
                    self.args,
                    self.component_initializer.usersettings,
                    self.component_initializer.ledsettings,
                ...
                self.component_initializer.menu.show()
                self.component_initializer.ledsettings.add_instance(
                    self.component_initializer.menu, self.component_initializer.ledstrip
                )
