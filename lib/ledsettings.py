    ...
    def set_sequence(self, sequence, step, direct_step=False):
        try:
            if int(step) == 0 or direct_step is True:
                ...
                self.next_step = (
                    self.sequences_tree.getElementsByTagName(
                        "sequence_" + str(self.sequence_number)
                    )[0]
                    .getElementsByTagName("next_step")[0]
                ...
                self.control_number = (
                    ...
                    .getElementsByTagName("control_number")[0]
                    .firstChild.nodeValue
                )
                self.count_steps = 1
                ...
                while True:
                    try:
                        temp_step = (
                            ...
                            .getElementsByTagName("step_" + str(self.count_steps))[0]
            ...
            self.color_mode = (
                ...
                .getElementsByTagName("step_" + str(self.step_number))[0]
                .getElementsByTagName("color")[0]
                .firstChild.nodeValue
            )
            self.mode = (
                ...
                .getElementsByTagName("step_" + str(self.step_number))[0]
                .getElementsByTagName("light_mode")[0]
                .firstChild.nodeValue
            )

            if self.mode == "Velocity" or self.mode == "Fading" or self.mode == "Pedal":
                self.fadingspeed = int(
                    self.sequences_tree.getElementsByTagName(
                        "sequence_" + str(self.sequence_number)
                    )[0]
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("fadingspeed")[0]
                    .firstChild.nodeValue
                )
                if self.mode == "Fading":
            ...
            if self.color_mode == "Rainbow":
                ...
                self.rainbow_timeshift = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("Timeshift")[0]
                    .firstChild.nodeValue
                )
                self.rainbow_colormap = (
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("Colormap")[0]
                    .firstChild.nodeValue
                )
            ...
            if self.color_mode == "Speed":
                self.speed_slowest["red"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("speed_slowest_red")[0]
                    .firstChild.nodeValue
                )
                self.speed_slowest["green"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("speed_slowest_green")[0]
                    .firstChild.nodeValue
                )
                self.speed_slowest["blue"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("speed_slowest_blue")[0]
                    .firstChild.nodeValue
                )
                ...
                self.speed_fastest["red"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("speed_fastest_red")[0]
                    .firstChild.nodeValue
                )
                self.speed_fastest["green"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("speed_fastest_green")[0]
                    .firstChild.nodeValue
                )
                self.speed_fastest["blue"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("speed_fastest_blue")[0]
                    .firstChild.nodeValue
                )
                ...
                self.speed_period_in_seconds = float(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("speed_period_in_seconds")[0]
                    .firstChild.nodeValue
                )
                self.speed_max_notes = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("speed_max_notes")[0]
                    .firstChild.nodeValue
                )
            ...
            if self.color_mode == "Gradient":
                self.gradient_start["red"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("gradient_start_red")[0]
                    .firstChild.nodeValue
                )
                self.gradient_start["green"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("gradient_start_green")[0]
                    .firstChild.nodeValue
                )
                self.gradient_start["blue"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("gradient_start_blue")[0]
                    .firstChild.nodeValue
                )
                ...
                self.gradient_end["red"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("gradient_end_red")[0]
                    .firstChild.nodeValue
                )
                self.gradient_end["green"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("gradient_end_green")[0]
                    .firstChild.nodeValue
                )
                self.gradient_end["blue"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("gradient_end_blue")[0]
                    .firstChild.nodeValue
                )
            ...
            if self.color_mode == "Scale":
                self.key_in_scale["red"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("key_in_scale_red")[0]
                    .firstChild.nodeValue
                )
                self.key_in_scale["green"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("key_in_scale_green")[0]
                    .firstChild.nodeValue
                )
                self.key_in_scale["blue"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("key_in_scale_blue")[0]
                    .firstChild.nodeValue
                )
                ...
                self.key_not_in_scale["red"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("key_not_in_scale_red")[0]
                    .firstChild.nodeValue
                )
                self.key_not_in_scale["green"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("key_not_in_scale_green")[0]
                    .firstChild.nodeValue
                )
                self.key_not_in_scale["blue"] = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("key_not_in_scale_blue")[0]
                    .firstChild.nodeValue
                )
                ...
                self.scale_key = int(
                    ...
                    .getElementsByTagName("step_" + str(self.step_number))[0]
                    .getElementsByTagName("scale_key")[0]
                    .firstChild.nodeValue
                )
                ...
                while True:
                    try:
                        colors = (
                            ...
                            .getElementsByTagName("step_" + str(self.step_number))[0]
                            .getElementsByTagName("color_" + str(multicolor_number))[0]
                            .firstChild.nodeValue
                        )
                        colors = colors.split(",")
                    ...
                    try:
                        colors_range = (
                            ...
                            .getElementsByTagName(
                                "color_range_" + str(multicolor_range_number)
                            )[0]
                            .firstChild.nodeValue
                        )
