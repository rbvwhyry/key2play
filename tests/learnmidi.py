...
for msg in learning.song_tracks:
    ...
    tDelay = mido.tick2second(
        msg.time,
        learning.ticks_per_beat,
        learning.song_tempo * 100 / learning.set_tempo,
    )
    ...
    if not msg.is_meta:
        ...
        if (
            msg.type == "note_on"
            and msg.velocity > 0
            and (msg.channel == learning.hands or learning.hands == 0)
        ):
        ...
        if (
            (
                learning.hands == 1 and learning.mute_hand != 2 and msg.channel == 2
            )  # send midi sound for Left hand
            or (
                learning.hands == 2 and learning.mute_hand != 1 and msg.channel == 1
            )  # send midi sound for Right hand
            or learning.practice == 2
